...
#
# Ejecución remota:
#   curl -sL https://raw.githubusercontent.com/nipegun/debilive-scripts/refs/heads/main/InstSO/OpenWrtX86-Instalar-Custom.sh | bash
#   curl -sL https://raw.githubusercontent.com/nipegun/debilive-scripts/refs/heads/main/InstSO/OpenWrtX86-Instalar-Custom.sh | sed 's-/dev/sda-/dev/vda-g' | bash
# ----------
